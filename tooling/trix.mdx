...
Generate code bindings (client libraries) for the smart contracts defined in your Tx3 project. Bindings are templated using handlebars and can target multiple languages, including TypeScript, Rust, Go, and Python.
For detailed information about configuring and using bindgen, see the [Bindgen Guide](../integration/bindgen).
