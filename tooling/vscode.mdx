...
To use the Tx3 extension, you must first ensure that the **tx3 toolchain** is installed on your system. You can find detailed installation instructions and a quick start guide in the [official Tx3 documentation](https://docs.txpipe.io/tx3/authoring/quick-start).
