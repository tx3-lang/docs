...
Devnet is a custom Cardano test network powered by Dolos. It allows you to define initial wallet funds, execute transactions, etc. To set up the environment, you must run [tx3up](./tx3up). It launches Dolos using custom genesis files for the Devnet network.
