...
- a DSL (Domain Specific Language) to describe the interface of your UTxO protocol.
- a runtime for interacting with UTxO protocols through the use of these interface definitions.
- a codegen framework for creating strongly-typed clients for UTxO protocols.
